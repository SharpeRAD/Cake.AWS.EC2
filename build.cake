    ...
    .Does(() =>
{
    ...
    CopyFileToDirectory("./lib/AWSSDK.Core.dll", "./test/tools/Addins/Cake.AWS.EC2/lib/net45/");
    CopyFileToDirectory("./lib/AWSSDK.EC2.dll", "./test/tools/Addins/Cake.AWS.EC2/lib/net45/");
});
